...
public class ElectrolysisMenu extends AbstractContainerMenu {
    // --- 変数宣言 ---
    public ElectrolysisMenu(int a, Inventory inventory){
        this(a, inventory, new SimpleContainer(4));
    }

    private Container container;

    public ElectrolysisMenu(int a, Inventory inventory, Container container) {
        super(InstantHealModMenuTypes.ELECTROLYSISMENU.get(), a);
